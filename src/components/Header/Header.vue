    ...
    <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':loginShow}">
      <div class="md-modal-inner">
        <div class="md-top">
          ...
          <button class="md-close" @click.prevent.stop="loginShow=false">Close</button>
        </div>
        <div class="md-content">
          <div class="confirm-tips">
            ...
            <ul>
              <li class="regi_form_input" style="margin-bottom: 10px;">
              ...
              <li class="regi_form_input noMargin">
                ...
                <input type="password" tabindex="2"  name="password" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password" v-model="password">
              </li>
            </ul>
          </div>
